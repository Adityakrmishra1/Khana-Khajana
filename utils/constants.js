const LOGO_URL =
  "https://cdn.pixabay.com/photo/2022/08/02/04/46/icon-7359529_1280.png";
const CDN_URL =
...
const COMPANY_NAME = "Khana Khajana";

const TOP_RATE_RATING = 4.0;
...
module.exports = {
  ...
  TOP_RATE_RATING : TOP_RATE_RATING,
};
