...
let RestaurantsItem = function (props) {
	return (
		<div className="res-item">
			...
			<h3 className="res-item-title"> {props.resName} </h3>
			<h4 className="res-item-cusine"> {props.cuisine} </h4>
			<h5 className="res-item-rating"> {props.rating} </h5>
			<h5 className="res-item-eta"> {props.eta} </h5>
		</div>
	);
}
